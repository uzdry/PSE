...
\section{Terminal und Proxy testen}
	...
	\subsection{Multibenutzer}
		...
		\begin{itemize}
			...
			\item Wenn der Client die Verbindung trennt, soll der Proxy auf Server-Seite gelöscht werden. Davor sollen aber alle Subscriptions des Proxy gelöscht werden. Die Methode \code{unsubscribeAll(): void} der Klasse Buss wird in den Unit-Tests abgedeckt.  ~\ref{}
