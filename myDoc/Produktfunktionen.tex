...
\section{Endgerät mit Server verbinden}
	...
	\begin{enumerate}
		...
		Vorbedingung: Bluetooth-Verbindung mit OBD2 Adapter ist hergestellt. \\ Auslösendes Ereignis: Von der Bluetooth-Schnittstelle treffen Daten ein.\\%%TODO: Check BT API Node.js server 
